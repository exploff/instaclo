...
export class ChatRoomService {
  ...
  public fetchChatRoomByUserUidFromORUserUidTo(uid: string): Observable<ChatRoom[]> {
    return this.genericFirestoreService.fetchByPropertySpecialChatInOrder<ChatRoom>(this.chatRoomCollection, "user_uid_from", "user_uid_to", uid, "created_date", "desc");
  }
